...
LIB_OFILES := $(LIB_CFILES:./lib/%.c=./build/%.o)
...
kernel8.img: ./build/boot.o ./build/uart.o $(OFILES) $(LIB_OFILES)
	aarch64-none-elf-ld -nostdlib ./build/boot.o ./build/uart.o $(OFILES) $(LIB_OFILES) -T ./kernel/link.ld -o ./build/kernel8.elf
